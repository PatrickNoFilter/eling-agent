...
- **Hermes Agent** — TUI design patterns (banner, panels, skin-aware colors) and plan-step tracking
...
|---------|---------|---------|
| [requests](https://pypi.org/project/requests/) | Apache 2.0 | HTTP client for API calls |
| [rich](https://pypi.org/project/rich/) | MIT | Terminal UI rendering |
| [markitdown](https://github.com/microsoft/markitdown) | MIT | Document conversion (optional) |
